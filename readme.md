...
ESP32-based MQTT client that subscribes to live power data and displays the current value on a 16x2 I2C LCD.

Designed for home energy monitoring setups (PV, grid consumption, battery systems, ioBroker, Home Assistant, Node-RED).
